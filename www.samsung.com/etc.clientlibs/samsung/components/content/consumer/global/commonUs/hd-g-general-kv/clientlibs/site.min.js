...
this.ele.nowMenu=this.ele.actMenu;this.ele.bar=this.ele.section.find(".hd-general-kv__bar");this.ele.leftWrap=this.ele.section.find(".hd-general-kv__menu");this.ele.leftbox=this.ele.section.find(".hd-general-kv__list");this.ele.dropBtn=this.ele.section.find(".hd-general-kv__headline-text");this.statePC=g.MOBILE<h.getViewPort().width;this.stateMOdrop=this.ele.section.hasClass("hd-general-kv--mobile-dropdown");this.menuTop=null;this.focusLock=function(a){a.keyCode===f.keyCode.TAB_KEY&&(!0===a.shiftKey&&
a.target===b.ele.menu.eq(0).find("a").target[0]?b.ele.section.find(".hd-general-kv__button").focus():setTimeout(function(){!1===a.shiftKey&&document.activeElement===b.ele.dropBtn.target[0]&&b.dropDownToggle(!0)},30))}.bind(this);this.leftMove=this.eventTouchMove.bind(this);this.leftEnd=this.eventTouchEnd.bind(this);this.leftMax=this.leftPad=this.leftBefore=null;e(this.ele.wrap).length&&this.init()};d.prototype.barSize=function(a){a=void 0===a?!1:a;if((!this.stateMOdrop||this.statePC)&&e(this.ele.nowMenu).length){var b=
this.ele.nowMenu,c=b.find("a").width();b=b.target[0].getBoundingClientRect().left;b+=-1*parseFloat(this.ele.leftbox.css("margin-left"));b+=this.leftPad;this.statePC&&(b-=this.ele.leftbox.target[0].getBoundingClientRect().left,b+=8);c={left:b+"px",width:c+"px"};a&&(c.transition="none",c["-o-transition"]="none",c["-ms-transition"]="none",c["-moz-transition"]="none",c["-webkit-transition"]="none");this.ele.bar.css(c);if(a){var d=this.ele.bar;setTimeout(function(){d.css({transition:"","-o-transition":"",
...
this.ele.dropBtn.attr("id","floating-nav-btn"),this.ele.dropBtn.append('\x3cspan class\x3d"hidden"\x3eMenu\x3c/span\x3e'),this.ele.section.find(".hd-general-kv__headline-text").attr("tabindex","0")):g.MOBILE<h.getViewPort().width&&null!==this.ele.wrap.attr("role")&&(this.ele.wrap.removeAttr("id","floating-nav-panel"),this.ele.wrap.removeAttr("role","region"),this.ele.wrap.removeAttr("aria-labelledby","floating-nav-btn"),this.ele.dropBtn.removeAttr("data-open-title","Click to open menu"),this.ele.dropBtn.removeAttr("data-close-title",
"Click to close menu"),this.ele.dropBtn.removeAttr("role","button"),this.ele.dropBtn.removeAttr("aria-expanded","false"),this.ele.dropBtn.removeAttr("aria-controls","floating-nav-panel"),this.ele.dropBtn.removeAttr("id","floating-nav-btn"),this.ele.dropBtn.find(".hidden").remove(),this.ele.section.find(".hd-general-kv__headline-text").removeAttr("tabindex"))};d.prototype.init=function(){this.resize(!0);this.bindEvents()};d.prototype.resize=function(a){a=void 0===a?!1:a;this.statePC=g.MOBILE<h.getViewPort().width;
this.leftPad=parseFloat(this.ele.actMenu.find("a").css("padding-left"));this.leftMax=this.ele.wrap.width()-this.ele.leftbox.width();this.statePC?(this.leftScrollGo(4,!1),this.dropDownToggle(!0)):this.stateMOdrop||0<this.ele.actMenu.length&&this.leftScroll(-1*(this.ele.actMenu.target[0].getBoundingClientRect().left+this.ele.actMenu.width()-this.ele.leftWrap.width()),a);this.barSize(!0);this.dropDownInit();this.fixMenu(!0)};d.prototype.eventTouchStart=function(a){this.leftBefore=void 0!==a.screenX?
a.screenX:a.touches[0].screenX;this.ele.window.on("touchmove",this.leftMove);this.ele.window.on("touchend",this.leftEnd);this.ele.window.on("mousemove",this.leftMove);this.ele.window.on("mouseup",this.leftEnd)};d.prototype.eventTouchMove=function(a){a=void 0!==a.screenX?a.screenX:a.touches[0].screenX;this.leftScroll(a-this.leftBefore);this.leftBefore=a};d.prototype.eventTouchEnd=function(){this.ele.window.off("touchmove",this.leftMove);this.ele.window.off("touchend",this.leftEnd);this.ele.window.off("mousemove",
this.leftMove);this.ele.window.off("mouseup",this.leftEnd)};d.prototype.leftScroll=function(a,b){b=void 0===b?!1:b;this.statePC||this.stateMOdrop||this.leftScrollGo(parseFloat(this.ele.leftbox.css("margin-left"))+a,b)};d.prototype.leftScrollGo=function(a,b){b=void 0===b?!1:b;0<this.leftMax?(this.ele.leftbox.css({marginLeft:""}),this.ele.bar.css({marginLeft:""})):(0<a?a=0:a<this.leftMax&&(a=this.leftMax),b?(this.ele.bar.stop(),this.ele.leftbox.stop(),this.ele.bar.css({marginLeft:a+"px"}),this.ele.leftbox.animate({marginLeft:a+
"px"},1E3)):(this.ele.bar.css({marginLeft:a+"px"}),this.ele.leftbox.css({marginLeft:a+"px"})))};d.prototype.fixMenu=function(a){var b=document.body.scrollTop||document.documentElement.scrollTop;if(void 0===a?0:a)this.ele.section.removeClass("hd-general-kv--fixed"),this.menuTop=this.ele.section.target[0].getBoundingClientRect().top+b;a=this.ele.section.hasClass("hd-general-kv--fixed");this.menuTop<b?a||this.ele.section.addClass("hd-general-kv--fixed"):a&&this.ele.section.removeClass("hd-general-kv--fixed")};
d.prototype.bindEvents=function(){var a=this;this.ele.menu.on("mouseenter",function(b){a.ele.nowMenu.target[0]!==b.currentTarget&&(a.ele.nowMenu=e(b.currentTarget),a.barSize())});this.ele.section.on("mouseleave",function(){a.ele.nowMenu=a.ele.actMenu;a.barSize()});this.ele.menu.on("focusin",function(b){a.ele.nowMenu.target[0]!==b.currentTarget&&(a.ele.nowMenu=e(b.currentTarget),a.barSize())});this.ele.section.on("focusout",function(){a.ele.nowMenu=a.ele.actMenu;a.barSize()});this.ele.window.on("scroll",
function(){a.fixMenu()});this.ele.window.on("resize",function(){a.resize()});this.stateMOdrop?(this.ele.dropBtn.on("click",function(){a.statePC||a.dropDownToggle()}),this.ele.dropBtn.on("keyup",function(b){a.statePC||b.keyCode!==f.keyCode.ENTER||a.dropDownToggle()})):(this.ele.leftbox.on("touchstart",this.eventTouchStart.bind(this)),this.ele.leftbox.on("mousedown",this.eventTouchStart.bind(this)),[].concat($jscomp.arrayFromIterable(this.ele.menu.find("a").target)).forEach(function(a){a.draggable=
!1}))};d.makeInstance=function(){e(".hd-general-kv").target.forEach(function(a){void 0===a.component_FloatingNavigation?a.component_FloatingNavigation=new d(a):a.component_FloatingNavigation.resize(!0)})};window.sg.components.floatingNavigation={reInit:c};e.ready(c);e.load(c)})();