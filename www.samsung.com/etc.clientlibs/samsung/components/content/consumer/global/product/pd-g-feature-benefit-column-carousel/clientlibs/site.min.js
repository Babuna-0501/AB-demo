...
f&&(c.freeMode=!0);g.slideRemove(b);g.slideInit(b,c);window.sg.common.image.initAll();this.el.slideBackBtn.attr("tabindex",-1);var n=g.getSwiper(b);if(n)n.on("slideChangeTransitionEnd",function(){n.activeIndex+d===n.slides.length?a.el.slideBackBtn.removeAttr("tabindex"):a.el.slideBackBtn.attr("tabindex",-1)})}else g.slideRemove(b),g.slideInit(b,{autoHeight:!0}),window.sg.common.image.initAll()}};d.prototype.resizeActive=function(){var a=this;q.setLazyLoad();this.setDefault();"desktop"===h.getCurrentDevice()?
...
e(b);c.on("load",function(){a.setHeight(c.closest(a.selector.itemList).target[0])})}))}}})};d.prototype.resize=function(){var a=this;if(0<this.el.component.closest(".tab-container__panel").target.length&&!this.el.component.closest(".tab-container__panel").hasClass("is-active"))return!1;this.el.component.target.forEach(function(b){b=e(b).find(a.selector.componentInner);var c=b.attr("data-desktop-per-page")>b.attr("data-mobile-per-page")?"desktop":"mobile",d="mobile"===c?"desktop":"mobile";!1===a.startFlag?
(b.attr("data-desktop-per-page")||b.attr("data-mobile-per-page")?(a.viewMoreItem(b),b.hasClass("use-mobile-carousel")||h.getCurrentDevice()!==d||(a.resizeFlag=!0)):setTimeout(function(){a.resizeActive()},100),a.startFlag=!0):(!1!==a.moreFlag||!b.attr("data-desktop-per-page")&&!b.attr("data-mobile-per-page")||b.hasClass("use-mobile-carousel")||h.getCurrentDevice()!==c||!0!==a.resizeFlag||(a.el.itemList.removeClass("is-item-active"),a.el.itemList.removeClass("is-item-visible"),a.viewMoreItem(b),a.resizeFlag=
!1),setTimeout(function(){a.resizeActive()},100))})};d.prototype.bindEvents=function(){var a=this;t.off("resize",this.handler.resize).on("resize",this.handler.resize);this.el.slideBackBtn.target.forEach(function(b){e(b).off("click").on("click",function(){a.backSlide(b)})});this.el.videoPlayBtn.target.forEach(function(b){var c=e(b);c.off("click").on("click",function(){a.activeEmbed(c)})});this.el.videoCloseBtn.target.forEach(function(b){var c=e(b);c.off("click").on("click",function(){a.unactiveEmbed(c)});
c.off("keydown").on("keydown",function(b){var d=c.closest(a.selector.videoWrap);b.keyCode===m.TAB&&!1===b.shiftKey&&d.attr("tabindex","0").focus();b.keyCode===m.ENTER&&a.unactiveEmbed(c);b.preventDefault()})});this.el.videoWrap.target.forEach(function(b){var c=e(b);c.off("keydown").on("keydown",function(b){var d=c.find(a.selector.videoCloseBtn);b.keyCode===m.TAB&&!0===b.shiftKey&&(d.attr("tabindex","0").focus(),b.preventDefault())})});this.el.viewMoreBtn.target.forEach(function(b){var c=e(b);c.off("click").on("click",
function(){a.viewMoreItem(c.closest(a.selector.componentInner),"focus");a.moreFlag=!0})});this.el.ctaButton.target.forEach(function(b){e(b).off("click",a.handler.clickCtaButton).on("click",a.handler.clickCtaButton)})};var w=function(){t=e(window);u=e(".feature-column-carousel");u.target.length&&e(".feature-column-carousel").target.forEach(function(a){d.instances.has(a)||new d(a)})};d.instances=new WeakMap;e.ready(w);window.sg.components.featureColumnCarousel={init:w,reInit:function(a){a?(e(a).find(".basic-swiper").target.forEach(function(a){void 0===
a.swiper?g.slideInit(a):g.slideReInit(a)}),d.instances.has(a)?d.instances.get(a).reInit():new d(a)):e(".feature-column-carousel").target.forEach(function(a){e(a).find(".basic-swiper").target.forEach(function(a){void 0===a.swiper?g.slideInit(a):g.slideReInit(a)});d.instances.has(a)?d.instances.get(a).reInit():new d(a)})}}})();